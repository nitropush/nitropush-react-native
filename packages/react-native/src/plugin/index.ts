...
import {
  ...
  export const NITROMODULES_PODFILE_CXX_SNIPPET = [
    "    # NitroModules — Xcode 26 strict-modular-headers fix.",
    "    # 1. Build-settings: allow non-modular C++ stdlib includes inside a module.",
    ...
    "      end",
    "    end",
    "    # 2. Umbrella-header patch: wrap .hpp imports in #ifdef __cplusplus so",
    "    #    ObjC-mode module validation skips them; ObjC++ (Swift C++ interop) keeps them.",
