...
namespace margelo::nitro::nitropush {
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/nitropush/Func_void_DownloadProgress;";
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/nitropush/Func_void_DownloadProgress_cxx;";
